// psuedo-db for all project info
const allProjects = [
  {
    id: 1,
    title: "Buckey's One Stop Art Shop",
    description: "My capstone project for Epicodus: An e-commerce website that allows an artist (admin) to upload artworks to a database and select a timeframe to sell a single piece of art. The user sees the art, the count-down timer, and a buy button. The user can add the art to their cart! This is still in developement and uses Typescript, React, Firebase, and Vite.",
    imgSrc: "./src/assets/img/buckeyfront.gif",
    link: "https://github.com/emmalgs/buckeys-one-stop-art-shop"
  },
  {
    id: 2,
    title: "Corn Shack",
